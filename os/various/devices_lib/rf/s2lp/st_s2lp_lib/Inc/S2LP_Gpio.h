...
void S2LPGpioInit(S2LPDriver *devp, SGpioInit* pxGpioInitStruct);
void S2LPGpioSetLevel(S2LPDriver *devp, S2LPGpioPin xGpioX, OutputLevel xLevel);
OutputLevel S2LPGpioGetLevel(S2LPDriver *devp, S2LPGpioPin xGpioX);
void S2LPGpioClockOutput(S2LPDriver *devp, SFunctionalState xNewState);
void S2LPGpioClockOutputInit(S2LPDriver *devp, ClockOutputInit* pxClockOutputInitStruct);
void S2LPGpioSetXOPrescaler(S2LPDriver *devp, ClockOutputXOPrescaler xXOPrescaler);
ClockOutputXOPrescaler S2LPGpioGetXOPrescaler(S2LPDriver *devp);
void S2LPGpioSetRCOPrescaler(S2LPDriver *devp, ClockOutputRCOPrescaler xRCOPrescaler);
ClockOutputRCOPrescaler S2LPGpioGetRCOPrescaler(S2LPDriver *devp);
void S2LPGpioSetExtraClockCycles(S2LPDriver *devp, ExtraClockCycles xExtraCycles);
ExtraClockCycles S2LPGpioGetExtraClockCycles(S2LPDriver *devp);

void S2LPGpioIrqDeInit(S2LPDriver *devp, S2LPIrqs* pxIrqInit);
void S2LPGpioIrqInit(S2LPDriver *devp, S2LPIrqs* pxIrqInit);
void S2LPGpioIrqConfig(S2LPDriver *devp, IrqList xIrq, SFunctionalState xNewState);
void S2LPGpioIrqGetMask(S2LPDriver *devp, S2LPIrqs* pxIrqMask);
void S2LPGpioIrqGetStatus(S2LPDriver *devp, S2LPIrqs* pxIrqStatus);
void S2LPGpioIrqClearStatus(S2LPDriver *devp);
SBool S2LPGpioIrqCheckFlag(S2LPDriver *devp, IrqList xFlag);
