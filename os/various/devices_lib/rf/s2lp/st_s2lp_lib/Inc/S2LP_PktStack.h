 ...
 * @retval None.
 */
#define S2LPPktStackSetPreambleLength(devp, xPreambleLength)                        S2LPSetPreambleLength(devp, xPreambleLength)
 ...
 */
#define S2LPPktStackGetPreambleLength(devp)                                      S2LPGetPreambleLength(devp)
 ...
 * @retval None.
 */
#define S2LPPktStackSetSyncLength(devp, xSyncLength)                                S2LPSetSyncLength(devp, (PktSyncLength)xSyncLength)
 ...
 */
#define S2LPPktStackGetSyncLength(devp)                                           S2LPGetSyncLength(devp)
 ...
 * @retval None.
 */
#define S2LPPktStackFilterOnCrc(devp, xNewState)                                    S2LPPktCommonFilterOnCrc(devp, xNewState)
 ...
 * @retval None.
 */
#define S2LPPktStackWhitening(devp, xNewState)                                     S2LPWhitening(devp, xNewState)
 ...
 * @retval None.
 */
#define S2LPPktStackFec(devp, xNewState)                                            S2LPFec(devp, xNewState)
 ...
 * @retval None.
 */
#define S2LPPktStackSetSyncWords(devp, lSyncWords, xSyncLength)                    S2LPSetSyncWords(devp, lSyncWords,xSyncLength)
