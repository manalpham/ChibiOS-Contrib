...
#define S2LPSpiWriteRegisters(devp, addr, n, regsp)								\
			s2lp_spi_write_regs(devp, addr, n, regsp)
#define S2LPSpiReadRegisters(devp, addr, n, regsp)       							\
			s2lp_spi_read_regs(devp, addr, n, regsp)
#define S2LPSpiCommandStrobes(devp, cmd)		                         			\
			s2lp_spi_cmd_strobes(devp, cmd)
