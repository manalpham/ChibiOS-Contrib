 ...
 * @retval None.
 */
#define S2LPPktWMbusSetPreambleLength(devp, xPreambleLength)                S2LPPktCommonSetPreambleLength(devp, (PktPreambleLength)xPreambleLength)
 ...
 */
#define S2LPPktWMbusGetPreambleLength(devp)                               S2LPPktCommonGetPreambleLength(devp)
