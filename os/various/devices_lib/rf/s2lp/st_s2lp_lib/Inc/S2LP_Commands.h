 ...
 */
#define S2LPCmdStrobeTx(devp)             {uint8_t tmp=0x9C; S2LPSpiWriteRegisters(devp, 0x76,1,&tmp);\
                                          S2LPCmdStrobeCommand(devp, CMD_TX);}
 ...
 */
#define S2LPCmdStrobeRx(devp)             {uint8_t tmp=0x90; S2LPSpiWriteRegisters(devp ,0x76,1,&tmp);\
                                          S2LPCmdStrobeCommand(devp, CMD_RX);}

#define S2LPCmdStrobeReady(devp)          S2LPCmdStrobeCommand(devp, CMD_READY)
#define S2LPCmdStrobeStandby(devp)        S2LPCmdStrobeCommand(devp, CMD_STANDBY)
#define S2LPCmdStrobeSleep(devp)          S2LPCmdStrobeCommand(devp, CMD_SLEEP)
#define S2LPCmdStrobeLockRx(devp)         S2LPCmdStrobeCommand(devp, CMD_LOCKRX)
#define S2LPCmdStrobeLockTx(devp)         S2LPCmdStrobeCommand(devp, CMD_LOCKTX)
#define S2LPCmdStrobeSabort(devp)         S2LPCmdStrobeCommand(devp, CMD_SABORT)
#define S2LPCmdStrobeLdcReload(devp)      S2LPCmdStrobeCommand(devp, CMD_LDC_RELOAD)
#define S2LPCmdStrobeSequenceUpdate(devp) S2LPCmdStrobeCommand(devp, CMD_SEQUENCE_UPDATE)
#define S2LPCmdStrobeSres(devp)           S2LPCmdStrobeCommand(devp, CMD_SRES)
#define S2LPCmdStrobeFlushRxFifo(devp)    S2LPCmdStrobeCommand(devp, CMD_FLUSHRXFIFO)
#define S2LPCmdStrobeFlushTxFifo(devp)    S2LPCmdStrobeCommand(devp, CMD_FLUSHTXFIFO)
...
void S2LPCmdStrobeCommand(S2LPDriver *devp, S2LPCmd xCommandCode);
