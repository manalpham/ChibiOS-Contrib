 ...
 * @retval None.
 */
#define S2LPPktBasicSetPreambleLength(devp, xPreambleLength)                S2LPSetPreambleLength(devp, xPreambleLength)
 ...
 */
#define S2LPPktBasicGetPreambleLength(devp)                               S2LPGetPreambleLength(devp)
 ...
 * @retval None.
 */
#define S2LPPktBasicSetSyncLength(devp, xSyncLength)                        S2LPSetSyncLength(devp, (PktSyncLength)xSyncLength)
 ...
 */
#define S2LPPktBasicGetSyncLength(devp)                                   S2LPGetSyncLength(devp)
 ...
 * @retval None.
 */
#define S2LPPktBasicFilterOnCrc(devp, xNewState)                            S2LPPktCommonFilterOnCrc(devp, xNewState)
 ...
 * @retval None.
 */
#define S2LPPktBasicWhitening(devp, xNewState)                               S2LPWhitening(devp, xNewState)
 ...
 * @retval None.
 */
#define S2LPPktBasicFec(devp, xNewState)                                     S2LPFec(devp, xNewState)
 ...
 * @retval None.
 */
#define S2LPPktBasicSetSyncWords(devp, lSyncWords, xSyncLength)              S2LPSetSyncWords(devp, lSyncWords, xSyncLength)
