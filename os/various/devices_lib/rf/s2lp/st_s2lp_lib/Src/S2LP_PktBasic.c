 ...
 * @retval None.
 */
void S2LPPktBasicInit(S2LPDriver *devp, PktBasicInit* pxPktBasicInit)
{
  uint8_t tmpBuffer[6];
  ...
  if(pxPktBasicInit->xCrcMode == PKT_NO_CRC) {
    S2LPPktBasicFilterOnCrc(devp, S_DISABLE);
  }
  else {
    S2LPPktBasicFilterOnCrc(devp, S_ENABLE);
  }
 ...
 * @retval None.
 */
void S2LPPktBasicGetInfo(S2LPDriver *devp, PktBasicInit* pxPktBasicInit)
{
  uint8_t tmpBuffer[6];
 ...
 * @retval None.
 */
void S2LPPktBasicAddressesInit(S2LPDriver *devp, PktBasicAddressesInit* pxPktBasicAddresses)
{
  uint8_t tmpBuffer[3];
 ...
 * @retval None.
 */
void S2LPPktBasicGetAddressesInfo(S2LPDriver *devp, PktBasicAddressesInit* pxPktBasicAddresses)
{
  uint8_t tmpBuffer[3];
 ...
 * @retval None.
 */
void S2LPPktBasicSetFormat(S2LPDriver *devp)
{
  uint8_t tmp;
 ...
 * @retval None.
 */
void S2LPPktBasicAddressField(S2LPDriver *devp, SFunctionalState xAddressField)
{
  uint8_t tmp;
 ...
 */
SFunctionalState S2LPPktBasicGetAddressField(S2LPDriver *devp)
{
  uint8_t tmp;

  g_xStatus = S2LPSpiReadRegisters(devp, PCKTCTRL4_ADDR, 1, &tmp);
 ...
 * @retval None.
 */
void S2LPPktBasicSetPayloadLength(S2LPDriver *devp, uint16_t nPayloadLength)
{
  uint8_t tmpBuffer[2];
  
  if(S2LPPktBasicGetAddressField(devp)) {
    nPayloadLength++;
  }
 ...
 */
uint16_t S2LPPktBasicGetPayloadLength(S2LPDriver *devp)
{
  uint8_t tmpBuffer[2];
 ...
 */
uint16_t S2LPPktBasicGetReceivedPktLength(S2LPDriver *devp)
{
  uint8_t tmpBuffer[2];
  uint16_t nPayloadLength;
