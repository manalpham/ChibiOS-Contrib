...
void S2LPGpioInit(S2LPDriver *devp, SGpioInit* pxGpioInitStruct)
{
  ...
  g_xStatus = S2LPSpiWriteRegisters(devp, pxGpioInitStruct->xS2LPGpioPin, 1, &tmp);
...
void S2LPGpioSetLevel(S2LPDriver *devp, S2LPGpioPin xGpioX, OutputLevel xLevel)
{
  ...
  g_xStatus = S2LPSpiWriteRegisters(devp, xGpioX, 1, &tmp);
...
OutputLevel S2LPGpioGetLevel(S2LPDriver *devp, S2LPGpioPin xGpioX)
{
  ...
  g_xStatus = S2LPSpiReadRegisters(devp, xGpioX, 1, &tmp);
...
void S2LPGpioIrqDeInit(S2LPDriver *devp, S2LPIrqs* pxIrqInit)
{
  ...
  g_xStatus = S2LPSpiWriteRegisters(devp, IRQ_MASK3_ADDR, 4, tmp);
}
...
void S2LPGpioIrqConfig(S2LPDriver *devp, IrqList xIrq, SFunctionalState xNewState)
{
  ...
  S2LPSpiReadRegisters(devp, IRQ_MASK3_ADDR, 4, tmpBuffer);
  ...
  g_xStatus = S2LPSpiWriteRegisters(devp, IRQ_MASK3_ADDR, 4, tmpBuffer);
...
void S2LPGpioIrqGetMask(S2LPDriver *devp, S2LPIrqs* pxIrqMask)
{
  ...
  g_xStatus = S2LPSpiReadRegisters(devp, IRQ_MASK3_ADDR, 4, tmp);
...
void S2LPGpioIrqGetStatus(S2LPDriver *devp, S2LPIrqs* pxIrqStatus)
{
  ...
  g_xStatus = S2LPSpiReadRegisters(devp, IRQ_STATUS3_ADDR, 4, tmp);
