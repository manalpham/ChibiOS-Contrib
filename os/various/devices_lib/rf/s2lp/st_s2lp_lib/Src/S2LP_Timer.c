 ...
 * @retval None.
 */
void S2LPTimerLdcrMode(S2LPDriver *devp, SFunctionalState xNewState)
{
  uint8_t tmp;
  s_assert_param(IS_SFUNCTIONAL_STATE(xNewState));
  
  S2LPSpiReadRegisters(devp, PROTOCOL1_ADDR, 1, &tmp);
  ...
  g_xStatus = S2LPSpiWriteRegisters(devp, PROTOCOL1_ADDR, 1, &tmp);
}
 ...
 * @retval None.
 */
void S2LPTimerLdcrAutoReload(S2LPDriver *devp, SFunctionalState xNewState)
{
  uint8_t tmp;
  s_assert_param(IS_SFUNCTIONAL_STATE(xNewState));
 ...
 */
SFunctionalState S2LPTimerLdcrGetAutoReload(S2LPDriver *devp)
{
  uint8_t tmp;
  g_xStatus = S2LPSpiReadRegisters(devp, PROTOCOL1_ADDR, 1, &tmp);
 ...
 * @retval None.
 */
void S2LPTimerSetRxTimer(S2LPDriver *devp, uint8_t cCounter , uint8_t cPrescaler)
{
  uint8_t tmpBuffer[2] = {cCounter, cPrescaler};
  g_xStatus = S2LPSpiWriteRegisters(devp, TIMERS5_ADDR, 2, tmpBuffer);
}
 ...
 * @retval None
 */
void S2LPTimerSetRxTimerUs(S2LPDriver *devp, uint32_t lDesiredUsec)
{
  uint8_t tmpBuffer[2];
 ...
 * @retval None.
 */
void S2LPTimerSetRxTimerCounter(S2LPDriver *devp, uint8_t cCounter)
{
  g_xStatus = S2LPSpiWriteRegisters(devp, TIMERS5_ADDR, 1, &cCounter);
}
 ...
 * @retval None
 */
void S2LPTimerSetRxTimerPrescaler(S2LPDriver *devp, uint8_t cPrescaler)
{
  g_xStatus = S2LPSpiWriteRegisters(devp, TIMERS4_ADDR, 1, &cPrescaler);
}
 ...
 * @retval None.
 */
void S2LPTimerGetRxTimerUs(S2LPDriver *devp, uint32_t* plTimeoutUsec, uint8_t* pcCounter , uint8_t* pcPrescaler)
{
  uint8_t tmpBuffer[2];
  
  g_xStatus = S2LPSpiReadRegisters(devp, TIMERS5_ADDR, 2, tmpBuffer);
 ...
 * @retval None.
 */
void S2LPTimerSetWakeUpTimer(S2LPDriver *devp, uint8_t cCounter , uint8_t cPrescaler)
{
  uint8_t tmpBuffer[2] = {cPrescaler, cCounter};
  g_xStatus = S2LPSpiWriteRegisters(devp, TIMERS3_ADDR, 2, tmpBuffer);
}
 ...
 * @retval None.
 */
void S2LPTimerSetWakeUpTimerUs(S2LPDriver *devp, uint32_t lDesiredUsec)
{
  ...
  S2LPSpiReadRegisters(devp, PROTOCOL2_ADDR, 1, &tmp);
  tmp &= ~LDC_TIMER_MULT_REGMASK;
  tmp |= multi;
  S2LPSpiWriteRegisters(devp, PROTOCOL2_ADDR, 1, &tmp);
 ...
 * @retval None.
 */
void S2LPTimerSetWakeUpTimerCounter(S2LPDriver *devp, uint8_t cCounter)
{
  g_xStatus = S2LPSpiWriteRegisters(devp, TIMERS2_ADDR, 1, &cCounter);
}
 ...
 * @retval None.
 */
void S2LPTimerSetWakeUpTimerPrescaler(S2LPDriver *devp, uint8_t cPrescaler)
{
  g_xStatus = S2LPSpiWriteRegisters(devp, TIMERS3_ADDR, 1, &cPrescaler);
}
 ...
 * @retval None.
 */
void S2LPTimerGetWakeUpTimerUs(S2LPDriver *devp, uint32_t* plWakeUpUsec, uint8_t* pcCounter, uint8_t* pcPrescaler, uint8_t* pcMulti)
{
  ...
  *pcMulti = tmp;
  ...
  g_xStatus = S2LPSpiReadRegisters(devp, TIMERS3_ADDR, 2, tmpBuffer);
 ...
 * @retval None.
 */
void S2LPTimerSetWakeUpTimerReload(S2LPDriver *devp, uint8_t cCounter , uint8_t cPrescaler, uint8_t cMulti)
{
  ...
  g_xStatus = S2LPSpiWriteRegisters(devp, TIMERS1_ADDR, 2, tmpBuffer);
}
 ...
 * @retval None.
 */
void S2LPTimerSetWakeUpTimerReloadUs(S2LPDriver *devp, uint32_t lDesiredUsec)
{
  uint8_t tmpBuffer[2], multi, tmp;
 ...
 * @retval None
 */
void S2LPTimerSetWakeUpTimerReloadCounter(S2LPDriver *devp, uint8_t cCounter)
{
  g_xStatus = S2LPSpiWriteRegisters(devp, TIMERS0_ADDR, 1, &cCounter);
}
 ...
 * @retval None
 */
void S2LPTimerSetWakeUpTimerReloadPrescaler(S2LPDriver *devp, uint8_t cPrescaler)
{
  g_xStatus = S2LPSpiWriteRegisters(devp, TIMERS1_ADDR, 1, &cPrescaler);
}
 ...
 * @retval None.
 */
void S2LPTimerGetWakeUpTimerReloadUs(S2LPDriver *devp, uint32_t* plWakeUpReloadUsec, uint8_t* pcCounter, uint8_t* pcPrescaler, uint8_t* pcMulti)
{
  uint8_t tmpBuffer[2], tmp;
 ...
 * @retval None
 */
void S2LPTimerSetRxTimerStopCondition(S2LPDriver *devp, RxTimeoutStopCondition xStopCondition)
{
  uint8_t tmp;
  ...
  S2LPSpiReadRegisters(devp, PCKT_FLT_OPTIONS_ADDR, 1, &tmp);
  tmp &= ~RX_TIMEOUT_AND_OR_SEL_REGMASK;
  tmp |= (((uint8_t)xStopCondition) >> 1);
  g_xStatus = S2LPSpiWriteRegisters(devp, PCKT_FLT_OPTIONS_ADDR, 1, &tmp);
}
 ...
 * @retval None
 */
void S2LpTimerFastRxTermTimer(S2LPDriver *devp, SFunctionalState xNewState)
{
  uint8_t tmp;
  s_assert_param(IS_SFUNCTIONAL_STATE(xNewState));
 ...
 * @retval None
 */
void S2LpSetTimerFastRxTermTimer(S2LPDriver *devp, uint8_t fast_rx_word)
{
  g_xStatus = S2LPSpiWriteRegisters(devp, FAST_RX_TIMER_ADDR, 1, &fast_rx_word);
}
 ...
 */
void S2LpSetTimerFastRxTermTimerUs(S2LPDriver *devp, uint32_t fast_rx_us)
{
  uint8_t tmp,fast_rx_word;
  
  S2LPSpiReadRegisters(devp, CHFLT_ADDR, 1, &tmp);
 ...
 * @retval None
 */
void S2LPTimerCalibrationRco(S2LPDriver *devp, SFunctionalState xCalibration)
{
  uint8_t tmp;
 ...
 * @retval None
 */
void S2LPTimerSleepB(S2LPDriver *devp, SFunctionalState en)
{
  uint8_t tmp;
  
  s_assert_param(IS_SFUNCTIONAL_STATE(en));
  
  S2LPSpiReadRegisters(devp, PM_CONF0_ADDR, 1, &tmp);
  ...
  g_xStatus = S2LPSpiWriteRegisters(devp, PM_CONF0_ADDR, 1, &tmp);
}

void S2LPTimerLdcIrqWa(S2LPDriver *devp, SFunctionalState en)
{
  ...
  g_xStatus = S2LPSpiWriteRegisters(devp, 0x7B, 1, &tmp[1]);
  g_xStatus = S2LPSpiWriteRegisters(devp, 0x7A, 1, &tmp[0]);
}
